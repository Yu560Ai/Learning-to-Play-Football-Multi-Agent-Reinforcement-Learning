...
def build_scenario(builder):
  ...
  # Keep the official spatial layout, but do not terminate immediately on
  # possession change. This gives the agent room to learn defended carrying
  # instead of treating every failed duel as an instant terminal event.
